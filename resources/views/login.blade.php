        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary shadow border-0">
            <div class="card-header bg-transparent pb-5">
              ...
              <div class="btn-wrapper text-center">
                <a href="#" class="btn btn-neutral btn-icon">
                  <span class="btn-inner--icon"><img src="assets/assets/img/icons/common/github.svg"></span>
                  <span class="btn-inner--text">Github</span>
                </a>
                <a href="#" class="btn btn-neutral btn-icon">
                  <span class="btn-inner--icon"><img src="assets/assets/img/icons/common/google.svg"></span>
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form method="POST" role="form" action="/postlogin">
                @csrf
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    ...
                    <input name="emailnya" class="form-control" placeholder="Email" type="email">
                  </div>
                ...
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <input name="passwordnya" class="form-control" placeholder="Password" type="password">
                  </div>
                </div>
